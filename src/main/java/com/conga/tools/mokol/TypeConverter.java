 ...
 * @version	JATO/2.1.5 $Id: TypeConverter.java,v 1.12 2003/07/29 21:25:43 todd Exp $
 */
/*pkg*/ class TypeConverter extends Object
{
	/**
	 * Cannot instantiate
	 *
		...
		implements Listener, ConvertibleType
	{
		...
		public TypeConversion getTypeConversion(final Object targetTypeKey)
		{
		...
		public static void main(String[] args)
		{
			...
			if (!(TypeConverter.asType(String.class,new Test()) instanceof String))
				throw new Error();

			if (!(TypeConverter.asType(TestSuperclass.class,new Test()) instanceof Test))
				throw new Error();
